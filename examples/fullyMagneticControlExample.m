...
env = Environment(dstSigma = 3e-9, ...  % [N * m] disturbance of the torque
                  magnSigma = 2e-7);    % [T] noise to create actual magnetic field
...
sat = Satellite(diag([0.015 0.015 0.007])); % [kg * m^2] inertia tensor for satellite
